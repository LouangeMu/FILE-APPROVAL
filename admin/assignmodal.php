<div class="modal fade" id="test<?php echo $row['p_code']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        <option value="<?php echo $roweng['u_id']?>"><?php echo $roweng['fname']." ".$roweng['lname']?></option>
                    ...
                    ?>
                                                    ...
                                                    <div class="row">
                                                    <div class="col-lg-4">
                                                        <label style="float:left;padding-left:15px">Deadline</label>
</div>

                                                        <div class="col-lg-6">
                                                            <input type="date" class="form-control"
                                                                min="<?php echo date('Y-m-d')?>" name="dline"/>
                                                        </div>
                                                    </div>
