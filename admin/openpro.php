                    ...
                    <div class="sparkline13-list shadow-reset">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><i class="fa big-icon fa-folder-open"></i> Open Project Report</h1>
                            </div>
                        </div>
...
$findeng=$pdo_conn->prepare("SELECT * FROM tbl_projects where status=4");
$findeng->execute();
$i=0;
...
?>
    <tr>
     ...
     $findengi=$pdo_conn->prepare("SELECT * FROM tbl_task_assign WHERE p_id='".$row['p_code']."' and ass_stat=1 ");
     $findengi->execute();
     $rowengi=$findengi->fetch();
     $engi=$rowengi['ass_eng'];

     $engpro=$pdo_conn->prepare("SELECT * FROM users where u_id='".$engi."'");
     $engpro->execute();

     $rowengipro=$engpro->fetch();

     echo $enginame=$rowengipro['fname']." ".$rowengipro['lname'];
