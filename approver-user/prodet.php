                    ...
                    <div class="sparkline13-list shadow-reset">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><?php echo $_REQUEST['pid']."     ||".$title?></h1>
                            </div>
                        </div>
...
?>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-6">
                                    <form action="" id="savescouser" method="POST">
                                            <div class="row">
                                               
                                                <div class="col-lg-9">
                                                <div class="touchspin-inner">
                                                        <label>Comments</label>
                                                        <input type="hidden" class="form-control" value="<?php echo $_SESSION['username'] ?>" name="logged" required />
                                                        <input type="hidden" class="form-control" value="<?php echo $pro ?>" name="pro" required />
                                                        <textarea class="form-control" value="" name="comm" required rows="5"/></textarea>
                                                    </div>
                                                </div><br>
                                                <div class="col-lg-12">
                                                    <div class="touchspin-inner">
                                                    <div class="btn-group project-list-ad">
                                                    <button type="submit" id="myButton" class="btn btn-primary" >Send</button>
                                                    </div>
                                                    </div>
                                                </div>
</form>
